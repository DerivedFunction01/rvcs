      ...
      <DialogContent className="sm:max-w-2xl lg:max-w-3xl xl:max-w-4xl p-6 md:p-8">
        <DialogHeader className="space-y-2">
          <DialogTitle className="flex items-center gap-2 text-lg md:text-2xl">
            <User className="w-4 h-4 md:w-6 md:h-6 text-primary" /> Edit Customer Info
          </DialogTitle>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 py-2">
          {/* Column 1 */}
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="space-y-1.5">
              <label className="text-xs md:text-sm font-medium text-muted-foreground flex items-center gap-1.5">
                <Phone className="w-3 h-3 md:w-4 md:h-4" /> Phone
              </label>
              <Input
                type="tel"
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                rows={orderType === OrderType.Delivery ? 3 : 6}
              />
            </div>
          </div>
        </div>
